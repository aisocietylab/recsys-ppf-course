...
#      url: "https://arxiv.org/pdf/<ARXIV PAPER ID>.pdf"
#    - label: Code
#      icon: fab fa-github
#      url: "https://github.com/aisocietylab/<CODE REPO>"
#    - label: arXiv
#      icon: ai ai-arxiv
#      url: "https://arxiv.org/abs/<ARXIV PAPER ID>"


  teaser:
    image: "/assets/images/RecSys_PPF_Teaser_Image_Styled.png"
    alt_text: "Stylized Teaser (created in draw.io, styled by Gemini)"
    caption: ""
    url: ""
  ...
  bibtex: |
    @misc{reiterhaas2026essai,
      title={Recommender Systems - Past, Present, and Future (Challenges)},
      author={Markus Reiter-Haas and Elisabeth Lex},
      year={2026},
      url={https://aisocietylab.github.io/recsys-ppf-course/}
    }
---
